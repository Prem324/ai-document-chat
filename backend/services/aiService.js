    ...
    try {
        const response = await axios.post('https://openrouter.ai/api/v1/chat/completions', {
            ...
            messages: [
                {
                    role: 'system',
                    content: "Answer the user question using only the provided document. If the answer is not found in the document, say 'The document does not contain this information'."
                },
                {
                    role: 'user',
